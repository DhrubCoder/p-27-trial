...
var playerArrows = [];
var board1, board2;
var pole1 , pole1Img , pole2 , pole2Img ;
...
function preload() {
  ...
  pole1Img = loadImage("./assets/pole.png");
  pole2Img = loadImage("./assets/pole.png");
...
function draw() {
  ...
  textSize(20);
  fill("blue");
  text("ARROWS LEFT = " + leftArrows ,  200 ,  90);

  fill("red");
  text("Make your ZOOM '110' for best experiance" , 220 , 120);
